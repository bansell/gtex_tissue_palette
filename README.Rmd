...
Note [**gtex_tissue_col_hex.tsv**](https://github.com/bansell/gtex_tissue_palette/blob/main/gtex_tissue_col_hex.tsv) is also provided. Note this does not preserve the factor order for plotting.
